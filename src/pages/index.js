...
const features = [
  {
    ...
    imageAlt: "ExcelToWordAutoReport - Marcos Lima",
    description: (
      <>
        Generate reports for your customers in word or pdf format from excel
        data automatically. You don't have to do it one by one.
      </>
    ),
  },
  {
